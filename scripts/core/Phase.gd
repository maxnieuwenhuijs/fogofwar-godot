...
static func is_rps(phase: int) -> bool:
	return phase == Type.SETUP_1_RPS or phase == Type.SETUP_2_RPS or phase == Type.SETUP_3_RPS
...
static func is_setup(phase: int) -> bool:
	return is_define(phase) or is_reveal(phase) or is_rps(phase) or is_linking(phase)

static func round_of(phase: int) -> int:
	match phase:
		Type.SETUP_1_DEFINE, Type.SETUP_1_REVEAL, Type.SETUP_1_RPS, Type.SETUP_1_LINKING:
			return 1
		Type.SETUP_2_DEFINE, Type.SETUP_2_REVEAL, Type.SETUP_2_RPS, Type.SETUP_2_LINKING:
			return 2
		Type.SETUP_3_DEFINE, Type.SETUP_3_REVEAL, Type.SETUP_3_RPS, Type.SETUP_3_LINKING:
			return 3
	return 0
...
static func rps_for_round(round_num: int) -> int:
	match round_num:
		1: return Type.SETUP_1_RPS
		2: return Type.SETUP_2_RPS
		3: return Type.SETUP_3_RPS
	return Type.PRE_GAME
